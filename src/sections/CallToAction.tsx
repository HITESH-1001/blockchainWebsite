                ...
                <div className="relative">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <Circle className="absolute left-0 -top-[400px]" animate>
                            <motion.img src="/assets/images/cuboid.png" className="size-[140px]" alt="" style={{ rotate: rotate }} />
                        </Circle>
                    </div>
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <Circle className="absolute -left-[600px] -top-[70px]" animate>
                            <motion.img src="/assets/images/cylinder.png" className="size-[140px]" alt="" style={
                                {
                                    rotate
                                }
                            } />
                    ...
                    <p className="text-xl lg:text-2xl text-zinc-400 text-center mt-8 max-w-sm mx-auto">Start building your next blockchain project </p>
