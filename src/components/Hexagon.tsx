...
export const Hexagon = (props: ComponentPropsWithoutRef<'svg'> & { size?: number; reverse?: boolean; duration?: number }) => {
    ...
    return (
        <div className="inline-flex relative">
            <svg width="82" height="72" viewBox="0 0 82 72" fill="none" strokeWidth="6" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" className={twMerge(" text-fuchsia-500/10 -rotate-6", className)} style={{ width: size, height: size }}>
            ...
            {totalPathLength && (
                ...
                <motion.svg  width="82" height="72" viewBox="0 0 82 72" fill="none" strokeWidth="6" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" className={twMerge(" text-fuchsia-500/10 -rotate-6 absolute", className)}
                    initial={{
                        strokeDashoffset: 0
                    }}
                    animate={{
                        strokeDashoffset:
                            reverse ? totalPathLength : totalPathLength * -1
                    }}
                    transition={{
                        duration,
                        repeat: Infinity,
